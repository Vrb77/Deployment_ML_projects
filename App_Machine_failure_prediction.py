...
TWF = st.number_input("TWF",options=[0, 1])
HDF = st.number_input("HDF",options=[0, 1])
PWF = st.number_input("PWF",options=[0, 1])
OSF = st.number_input("OSF",options=[0, 1])
RNF = st.number_input("RNF",options=[0, 1])
